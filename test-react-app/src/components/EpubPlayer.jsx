...
const EpubPlayer = () => {
    ...
    useEffect(() => {
        console.log('Initializing ePub player...');
    ...
    return (
        <div className="epub-player-container" style={{ paddingTop: '4rem' }}>
            <div className="epub-player-header" style={{ textAlign: 'center', marginBottom: '1rem' }}>
                <h1>Sunbird ePub Player - Vite React Test</h1>
            </div>
            <div
                ref={containerRef}
                className="epub-player-wrapper"
                style={{
                    height: '90vh',
                    width: '90%',
                    margin: '0 auto',

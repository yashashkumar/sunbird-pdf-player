...
const VideoPlayer = () => {
    ...
    useEffect(() => {
        // Create and configure the video player element
        const playerElement = document.createElement('sunbird-video-player');
        ...
        playerElement.addEventListener('playerEvent', (event) => {
            console.log('Video Player Event:', event.detail);
        });

        playerElement.addEventListener('telemetryEvent', (event) => {
            console.log('Video Player Telemetry:', event.detail);
        });
    ...
    return (
        <div className="video-player-container">
            <div className="video-player-header">
                <h1>Sunbird Video Player - Vite React Test</h1>
                <p>Testing the web component integration</p>
            </div>
            <div ref={containerRef} className="video-player-wrapper"></div>
        </div>
    );
};
